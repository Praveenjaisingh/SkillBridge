...
export default function Edit({ programmingLanguage }) {
    const { data, setData, put, processing, errors } = useForm({
        name: programmingLanguage.name ?? '',
        slug: programmingLanguage.slug ?? '',
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('programming-languages.update', programmingLanguage.id));
    };
        ...
        <AuthenticatedLayout
            header={
                <h2 className="text-xl font-semibold leading-tight text-gray-800">
                    Edit ProgrammingLanguage
                </h2>
            }
        >
            <Head title="Edit ProgrammingLanguage" />
