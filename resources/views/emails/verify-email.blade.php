<!-- Place this file at: resources/views/emails/verify-email.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px; background-color:#ffffff; border-radius:16px; overflow:hidden; box-shadow: 0 4px 20px rgba(56, 33, 124, 0.15);">
                ...
                <tr>
                    <td style="background: linear-gradient(135deg, #7057ee 0%, #a855f7 50%, #6238e0 100%); padding: 40px 32px; text-align:center;">
                        ...
                        <h1 style="margin:0; color:#ffffff; font-size:24px; font-weight:700;">Verify your email address</h1>
                        <p style="margin:8px 0 0; color:rgba(255,255,255,0.9); font-size:15px;">One quick step before you get started.</p>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding: 32px;">
                        ...
                        <p style="margin:0 0 24px; font-size:15px; line-height:1.6; color:#4b5563;">
                            Thanks for signing up for SkillBridge! Please confirm this is your email address by clicking the button below.
                        </p>

                        <table role="presentation" cellpadding="0" cellspacing="0" style="margin: 0 0 24px;">
                            <tr>
                                <td style="border-radius:10px; background: linear-gradient(135deg, #7057ee 0%, #6238e0 100%);">
                                    <a href="{{ $verificationUrl }}" style="display:inline-block; padding:12px 28px; font-size:14px; font-weight:600; color:#ffffff; text-decoration:none; letter-spacing:0.03em;">
                        ...
                        <p style="margin:0 0 24px; font-size:13px; line-height:1.6; word-break:break-all;">
                            <a href="{{ $verificationUrl }}" style="color:#7057ee;">{{ $verificationUrl }}</a>
                        </p>
